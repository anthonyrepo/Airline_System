...
public class AdminEditCancelSearchOrDropdownMenu {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AdminEditCancelSearchOrDropdownMenu window = new AdminEditCancelSearchOrDropdownMenu();
	...
	public AdminEditCancelSearchOrDropdownMenu() {
		initialize();
	}
